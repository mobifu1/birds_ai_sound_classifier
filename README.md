...
To manage the system, it features an integrated web server. This provides a user-friendly interface accessible from any device within your own local IP network. Through this web interface, you can easily view real-time detection data, control the application, and perform necessary administrative tasks.
