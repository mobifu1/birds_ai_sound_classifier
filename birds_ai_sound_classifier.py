...
# Startzeit für Laufzeiterfassung speichern
...
def inject_version():
    return dict(version="V1.3.7-RC2", year="2026")
...
def fft_page():
    ...
    return render_template('fft.html', all_species=all_species, version="V1.3.7-RC2", year=datetime.datetime.now().year)
